...
/* tagging */
static const char *tags[] = { "󰨓", "󰨓", "󰨓", "󰨓", "󰨓", "󰨓", "󰨓", "󰨓", "󰨓" };
...
static const char *reader[]   = { "st", "-e", "epy", NULL };
...
static const Key keys[] = {
    ...
    { 0,                            0x1008ff11,spawn,          SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-") },
    { 0,                            0x1008ff13,spawn,          SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+") },
    ...
    { 0,                            0xffc9,    spawn,          SHCMD("playerctl stop") },
    { 0,                            0xff61,    spawn,          SHCMD("ffmpeg -f x11grab -framerate 1 -video_size 1920x1080 -i :0.0 -vframes 1 output.jpg") },
